...
FAQS = [
    'メインは美容カウンセリングですが、未経験歓迎です。マニュアルがあり、先輩のカウンセリングに同席しながら覚えられます。接客業からの転職も歓迎で、医療の知識は入職後に身につけられます。',
    '個人ノルマはありません。「必要以上の美容治療は行わない」が当院のポリシーとして明文化されており、患者さまに不要なものを勧める仕事はそもそも存在しません。',
    '応募前の院内見学もできます（スタッフのみのバックヤードは除く）。ご応募はフォーム（1分）・チャット・お電話（050-8882-5880・採用担当：安田）から。選考には履歴書・職務経歴書が必要です。書類選考のうえ2営業日以内に面接（1回）の日程をご連絡します。',
...
CHAT = {
    ...
    "bridge": "応募前の見学もできます。ご応募はフォーム1分、またはお電話（050-8882-5880・採用担当：安田）から。選考には履歴書・職務経歴書をご用意ください。",
