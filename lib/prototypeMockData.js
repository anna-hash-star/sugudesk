...
// ====================================================================
// 法人マスタ・施設マスタ（実物クリニック求人レベルの階層構造）
// ====================================================================
export const corporations = {
  luna_corp: {
    id: 'luna_corp',
    name: '医療法人 Luna Ladies',
    establishedAt: '2018年4月1日',
    principle: '女性の人生のすべてのステージに寄り添う婦人科医療を提供する',
    directorMessage: 'Luna Ladies Clinicは、女性の心と体に寄り添うクリニックとして、地域に密着した医療を提供してまいりました。\n\n婦人科は患者さんが心身ともにデリケートな状態でいらっしゃることが多く、医師・看護師・スタッフ全員が、一人ひとりの患者さんの思いに丁寧に向き合うことを大切にしています。\n\n当院は、教育制度を充実させており、産婦人科未経験の看護師の方も自信を持って成長できる環境を整えています。\n\n女性が女性のために働く、温かい職場で一緒に医療を提供していきましょう。\n\n理事長　◯◯',
    facilities: ['luna_facility_main'],
    perks: [
      '美容施術スタッフ割引',
      '学会・勉強会参加費全額補助',
      'ホワイトニング・各種認定資格取得支援',
...
export const facilities = {
  luna_facility_main: {
    id: 'luna_facility_main',
    corpId: 'luna_corp',
    name: 'Luna Ladies Clinic',
    address: '東京都渋谷区...',
    access: 'JR渋谷駅西口 徒歩5分 / 東京メトロ「渋谷駅」徒歩3分',
    openedAt: '2018年4月1日',
    services: '無床診療所、婦人科、心療内科（一部）',
    businessHours: '平日 10:00〜13:00 / 14:30〜19:00\n土曜 10:00〜13:00 / 14:00〜18:00',
    closedDays: '日曜・祝日',
    patientCount: '1日40〜60名',
    staffComposition: {
      doctors: '常勤2名・非常勤2名',
      nurses: '常勤4名',
      medicalClerks: '常勤3名',
    ...
    equipment: ['電子カルテ（CLIUS）', 'オンライン予約システム', 'キャッシュレス決済', '超音波検査装置', '心電図', '血圧脈波測定装置', 'コルポスコピー', '採血用クリーンルーム'],
    director: '◯◯ 院長',
    directorBio: '産婦人科専門医として10年以上の臨床経験。総合病院の産婦人科部長を経て、2018年に当院を開院。\n\n2008年　△△大学医学部 卒業\n2008年〜2012年　△△大学附属病院 産婦人科 研修\n2012年〜2018年　××総合病院 産婦人科\n2018年〜　Luna Ladies Clinic 開院・院長',
  },
};

// ====================================================================
// 求人詳細：追加フィールド（実物レベル対応）
// ====================================================================
// jobPostingDetails の各エントリに対応する「拡張詳細」
export const jobPostingExtended = {
  jp_001: {
    facilityId: 'luna_facility_main',
    corpId: 'luna_corp',
    introduction: '看護師としての経験を活かして、地域に密着した婦人科クリニックで活躍しませんか？\n\n当院は患者様一人ひとりに丁寧に向き合うことを大切にしており、教育制度も充実しているため、産婦人科未経験の方も安心して成長していただけます。\n\n女性が女性のために働く、温かい職場で一緒に医療を提供していきましょう。',
    welcomedQualifications: ['認定看護師', '助産師資格保有者'],
    flexibility: {
      webInterview: true,
      onsiteVisit: true,
      sideJobOk: false,
      activelyWorkingOk: true,
    },
    trialPeriodNote: '試用期間中の条件変更なし、期間中も社保完備',
    workScope: '従事すべき業務の変更の範囲：なし',
    workplaceScope: '就業場所の変更の範囲：法人の定める範囲（追加開院時等）',
    incentiveDetail: 'スタッフ表彰制度（年2回）、勤続年数に応じた昇給',
    insuranceDetail: '健康保険、厚生年金、雇用保険、労災保険（雇用契約締結時より加入）',
    parkingPolicy: '通勤手当の範囲内で交通費別途支給、駐輪場あり',
  },
  jp_003: {
    facilityId: 'luna_facility_main',
    corpId: 'luna_corp',
    introduction: '当院は産婦人科に特化したクリニック。専門スキルを存分に発揮できる環境です。\n\n助産師として培われた経験を、産婦人科外来のサポート・母体管理・産前産後ケアに活かしていただけます。',
    welcomedQualifications: ['アロマセラピー資格', 'バースエデュケーター'],
    flexibility: {
      webInterview: true,
      onsiteVisit: true,
      sideJobOk: false,
    ...
    trialPeriodNote: '試用期間：3ヶ月（条件変更なし）',
    workScope: 'なし',
    workplaceScope: '法人の定める範囲',
  },
};

// ====================================================================
// 業務委託・契約系のメタデータ（医師求人など、業務委託形態用）
// ====================================================================
export const contractMetadata = {
  // 業務委託タイプ
  contractType: ['正職員', '業務委託', '契約職員', 'パート・バイト'],
  contractPeriod: {
    permanent: '期間の定めなし',
    fixed_2y_auto: '2年自動更新（双方協議により確定）',
    annual_review: '年俸制（決算月に次年度年俸決定）',
  },
};

// ====================================================================
// 「辞めない採用」KPI（事務長フィードバックに基づくミスマッチ防止訴求）
// ====================================================================
export const retentionKPI = {
  luna_ladies: {
    retention6m: 92,           // 直近6ヶ月の定着率（採用者のうち6ヶ月以上勤続している%）
    industryAvg6m: 77,         // 業界平均（紹介経由のクリニック既卒）
    mitigationSteps: [
      { id: 'job_posting',    label: '求人票に院の実態を反映', done: true,  description: '盛らない・隠さない、定着率を上げる原稿に' },
      { id: 'applicant_faq',  label: '応募者向けFAQの整備',    done: true,  description: '入職前の疑問を解消、ミスマッチを未然防止' },
      { id: 'interview_temp', label: '面接質問テンプレ作成',    done: true,  description: '業種別の見極めポイントを質問化' },
      { id: 'onboarding',     label: '入職後フォローの設定',   done: false, description: '1ヶ月/3ヶ月/6ヶ月チェックインで定着支援' },
    ],
    estimatedCostSaved: 450000, // 年間の推定離職コスト削減額
    referralFeeBenchmark: 760000, // 紹介手数料1件相当
    last12mHires: 4,
    last12mResignations: 0,
  },
  adeb: {
    retention6m: 80,
    industryAvg6m: 77,
    mitigationSteps: [
      { id: 'job_posting',    label: '求人票に院の実態を反映', done: true,  description: '美容クリニックの実態を正直に' },
      { id: 'applicant_faq',  label: '応募者向けFAQの整備',    done: false, description: '美容施術経験者向けFAQが未整備' },
      { id: 'interview_temp', label: '面接質問テンプレ作成',    done: true,  description: '美容経験の見極め質問' },
      { id: 'onboarding',     label: '入職後フォローの設定',   done: false, description: '1ヶ月/3ヶ月/6ヶ月チェックインが未設定' },
    ],
    estimatedCostSaved: 200000,
    referralFeeBenchmark: 760000,
    last12mHires: 2,
    last12mResignations: 1,
  },
  mikasa: {
    retention6m: null,
    industryAvg6m: 77,
    mitigationSteps: [
      { id: 'job_posting',    label: '求人票に院の実態を反映', done: false, description: '未着手（ヒアリング待ち）' },
      { id: 'applicant_faq',  label: '応募者向けFAQの整備',    done: false, description: '未着手' },
      { id: 'interview_temp', label: '面接質問テンプレ作成',    done: false, description: '未着手' },
      { id: 'onboarding',     label: '入職後フォローの設定',   done: false, description: '未着手' },
    ],
