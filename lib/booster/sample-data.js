...
export const sampleCandidates = [
  {
    ...
    aiAnalysis: {
      ...
      fit: [
        { label: '経験・スキル', level: 'high', note: '外科病棟5年・急性期300床' },
        { label: '資格・免許', level: 'high', note: '正看護師' },
        { label: '勤務条件', level: 'mid', note: '夜勤頻度の希望を確認' },
        { label: '在籍安定性', level: 'low', note: '短期離職の懸念、退職理由を確認' },
      ],
    },
    statusHistory: [
  ...
  },
  {
    ...
    aiAnalysis: {
      ...
      fit: [
        { label: '経験・スキル', level: 'high', note: '外科+ICU計7年・リーダー経験' },
        { label: '資格・免許', level: 'high', note: '正看護師（認定看護師取得へ学習中）' },
        { label: '勤務条件', level: 'mid', note: 'ICUから病棟への適応' },
        { label: '給与整合性', level: 'low', note: '希望年収がやや高い可能性' },
      ],
    },
    statusHistory: [
  ...
  },
  {
    ...
    aiAnalysis: {
      ...
      fit: [
        { label: '経験・スキル', level: 'mid', note: '急性期4年は厚いが訪問1年と短い' },
        { label: '資格・免許', level: 'high', note: '正看護師' },
        { label: '勤務条件', level: 'low', note: 'オンコール対応の耐性が未知数' },
        { label: '診療科経験', level: 'low', note: '訪問看護1年、在宅適性を確認' },
      ],
    },
    statusHistory: [
  ...
  },
  {
    ...
    aiAnalysis: {
      ...
      interviewPoints: [],
      fit: [
        { label: '経験・スキル', level: 'mid', note: '内科3年、基礎スキルは問題なし' },
        { label: '資格・免許', level: 'high', note: '正看護師' },
        { label: '勤務条件', level: 'mid', note: '大きな懸念なし' },
        { label: '診療科経験', level: 'low', note: '外科経験なし、面接で適性を確認' },
      ],
    },
    ngReason: {
  ...
  },
  {
    ...
    aiAnalysis: {
      ...
      fit: [
        { label: '経験・スキル', level: 'high', note: '外科3年+手術室2年' },
        { label: '資格・免許', level: 'high', note: '正看護師' },
        { label: '勤務条件', level: 'mid', note: '夜勤シフトの対応可否' },
        { label: '就業ブランク', level: 'low', note: '前職から3ヶ月のブランク' },
      ],
    },
    statusHistory: [
...
// 蓄積されたNG理由の履歴（傾向分析用）。stage: document=書類選考時 / interview=面接時
export const sampleNgRecords = [
  // 看護師
  { id: 'ng-r01', jobType: '看護師', jobTitle: '透析センター看護師', category: 'experience_mismatch', detail: '必要な診療科経験なし', stage: 'document', date: '2026-05-08' },
  { id: 'ng-r02', jobType: '看護師', jobTitle: '透析センター看護師', category: 'experience_mismatch', detail: '必要な診療科経験なし', stage: 'interview', date: '2026-05-14' },
  { id: 'ng-r03', jobType: '看護師', jobTitle: '訪問看護師', category: 'experience_mismatch', detail: '臨床年数不足', stage: 'document', date: '2026-05-20' },
  { id: 'ng-r04', jobType: '看護師', jobTitle: '透析センター看護師', category: 'experience_mismatch', detail: 'スキルレベル不足', stage: 'document', date: '2026-06-02' },
  { id: 'ng-r05', jobType: '看護師', jobTitle: '透析センター看護師', category: 'other_decided', detail: '候補者辞退（他院内定）', stage: 'interview', date: '2026-05-11' },
  { id: 'ng-r06', jobType: '看護師', jobTitle: '透析センター看護師', category: 'other_decided', detail: '候補者辞退（他院内定）', stage: 'document', date: '2026-05-28' },
  { id: 'ng-r07', jobType: '看護師', jobTitle: '訪問看護師', category: 'other_decided', detail: '候補者辞退（他院内定）', stage: 'interview', date: '2026-06-05' },
  { id: 'ng-r08', jobType: '看護師', jobTitle: '透析センター看護師', category: 'conditions_mismatch', detail: '給与希望が合わない', stage: 'interview', date: '2026-05-16' },
  { id: 'ng-r09', jobType: '看護師', jobTitle: '訪問看護師', category: 'conditions_mismatch', detail: '勤務形態が合わない（オンコール）', stage: 'interview', date: '2026-06-01' },
  { id: 'ng-r10', jobType: '看護師', jobTitle: '訪問看護師', category: 'conditions_mismatch', detail: '通勤距離', stage: 'document', date: '2026-06-10' },
  { id: 'ng-r11', jobType: '看護師', jobTitle: '透析センター看護師', category: 'culture_fit', detail: 'コミュニケーションスタイル', stage: 'interview', date: '2026-05-25' },
  { id: 'ng-r12', jobType: '看護師', jobTitle: '訪問看護師', category: 'motivation', detail: '長期就業の意思が不明', stage: 'interview', date: '2026-06-08' },
  { id: 'ng-r13', jobType: '看護師', jobTitle: '訪問看護師', category: 'other', detail: '連絡不通', stage: 'document', date: '2026-06-12' },
  // 理学療法士
  { id: 'ng-r14', jobType: '理学療法士', jobTitle: '理学療法士', category: 'culture_fit', detail: 'チームワーク志向の違い', stage: 'interview', date: '2026-05-19' },
  { id: 'ng-r15', jobType: '理学療法士', jobTitle: '理学療法士', category: 'motivation', detail: '志望理由が不明確', stage: 'interview', date: '2026-05-30' },
  { id: 'ng-r16', jobType: '理学療法士', jobTitle: '理学療法士', category: 'experience_mismatch', detail: '臨床年数不足', stage: 'document', date: '2026-06-04' },
  { id: 'ng-r17', jobType: '理学療法士', jobTitle: '理学療法士', category: 'other_decided', detail: '候補者辞退（現職残留）', stage: 'interview', date: '2026-06-09' },
  // 医療事務
  { id: 'ng-r18', jobType: '医療事務', jobTitle: '医療事務（外来）', category: 'conditions_mismatch', detail: '給与希望が合わない', stage: 'interview', date: '2026-05-22' },
  { id: 'ng-r19', jobType: '医療事務', jobTitle: '医療事務（外来）', category: 'conditions_mismatch', detail: '給与希望が合わない', stage: 'document', date: '2026-06-03' },
  { id: 'ng-r20', jobType: '医療事務', jobTitle: '医療事務（外来）', category: 'experience_mismatch', detail: 'スキルレベル不足（レセプト）', stage: 'document', date: '2026-06-07' },
  { id: 'ng-r21', jobType: '医療事務', jobTitle: '医療事務（外来）', category: 'motivation', detail: '志望理由が不明確', stage: 'interview', date: '2026-06-11' },
];

// カテゴリ別の色（傾向分析の識別用・カテゴリカル配色）
export const ngCategoryColors = {
  experience_mismatch: '#3b82f6',
  conditions_mismatch: '#f59e0b',
  other_decided: '#8b5cf6',
  culture_fit: '#14b8a6',
  motivation: '#ec4899',
  other: '#94a3b8',
};

// NG理由からの改善アクション（カテゴリ→示唆）
export const ngCategoryActions = {
  experience_mismatch: '求人要件の必須/歓迎ラインを見直し、エージェントへ推薦基準を再共有',
  conditions_mismatch: '給与・勤務条件レンジを再検討し、求人票で条件を明示',
  other_decided: '選考スピードを改善し、他院への競り負けを防ぐ',
  culture_fit: '面接での見極め観点を整理し、求人票で職場文化を具体化',
  motivation: '志望動機の事前ヒアリングを強化し、求人票の訴求を明確化',
  other: '連絡プロセス・日程調整の運用を見直す',
};

export const sampleRetention = [
  {
    id: 'ret-001',
    name: '鈴木 美香',
    jobTitle: '病棟看護師',
    ...
    status: 'active',
    followUps: [
      { timing: '1週間', date: '2026-03-08', status: 'done', note: '業務に慣れ始めている。プリセプターとの関係良好。', score: 4 },
      { timing: '1ヶ月', date: '2026-04-01', status: 'done', note: '夜勤にも入り始めた。電子カルテの操作に少し不安あり→フォロー実施。', score: 3 },
      { timing: '3ヶ月', date: '2026-06-01', status: 'done', note: '独り立ち完了。チームにも溶け込んでいる。長期定着の見込みあり。', score: 5 },
    ],
    retentionScore: 5,
    risk: 'low',
    learnings: ['電子カルテ研修を入職初週に集中実施すると立ち上がりが早い', '外科経験者はプリセプター期間を短縮可能'],
  },
  {
    id: 'ret-002',
    name: '伊藤 大輔',
    ...
    status: 'active',
    followUps: [
      { timing: '1週間', date: '2026-04-22', status: 'done', note: '同行訪問を開始。訪問件数は1日2件からスタート。', score: 4 },
      { timing: '1ヶ月', date: '2026-05-15', status: 'done', note: 'オンコール対応に不安あり。先輩看護師とペアで対応中。', score: 3 },
      { timing: '3ヶ月', date: '2026-07-15', status: 'upcoming', note: '', score: null },
    ],
    retentionScore: 3,
    risk: 'medium',
    learnings: ['オンコール研修を入職前に実施すると不安軽減に効果的'],
  },
  {
    id: 'ret-003',
    name: '松田 恵子',
    ...
    resignReason: '人間関係（病棟内のコミュニケーションスタイルが合わなかった）',
    tenure: '3ヶ月10日',
    followUps: [
      { timing: '1週間', date: '2026-01-17', status: 'done', note: '業務開始。特に問題なし。', score: 4 },
      { timing: '1ヶ月', date: '2026-02-10', status: 'done', note: '夜勤チームとの連携にやや課題あり。', score: 2 },
      { timing: '3ヶ月', date: '2026-04-10', status: 'done', note: '退職意向の相談あり。面談実施するも翻意できず。', score: 1 },
    ],
    retentionScore: 1,
    risk: 'high',
    learnings: ['1ヶ月フォローで「チーム連携の課題」が出た場合、即座に配置転換を検討すべき', '面接時にコミュニケーションスタイルの確認をより深く行う必要あり'],
  },
];

export const agencyResponseMetrics = [
  { agencyId: 'ag-001', name: 'マイナビ看護師', avgResponseHours: 8, recommendations: 3, ngFeedbackRate: 100 },
  { agencyId: 'ag-002', name: 'ナース人材バンク', avgResponseHours: 4, recommendations: 2, ngFeedbackRate: 100 },
  { agencyId: 'ag-003', name: 'レバウェル看護', avgResponseHours: 36, recommendations: 1, ngFeedbackRate: 100 },
  { agencyId: 'ag-004', name: 'ナースではたらこ', avgResponseHours: 72, recommendations: 0, ngFeedbackRate: 0 },
  { agencyId: 'ag-005', name: 'MCナースネット', avgResponseHours: 24, recommendations: 0, ngFeedbackRate: 0 },
];
